...
export declare class TelegramClient extends TelegramBaseClient {
     ...
     *  ```
     */
    pinMessage(entity: EntityLike, message?: MessageIDLike, pinMessageParams?: messageMethods.UpdatePinMessageParams): Promise<Api.Message | Api.messages.AffectedHistory | undefined>;
    /**
     ...
     *  ```
     */
    unpinMessage(entity: EntityLike, message?: MessageIDLike, unpinMessageParams?: messageMethods.UpdatePinMessageParams): Promise<Api.Message | Api.messages.AffectedHistory | undefined>;
    /**
